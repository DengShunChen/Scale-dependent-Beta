function [increment, x]=IncCal_sdl(y,Xp,prefix)

 % x.static
 x.static.l = prefix.da.beta1_inv * prefix.da.Bs.l * y.static.l;
 x.static.s = prefix.da.beta1_inv * prefix.da.Bs.s * y.static.s;
 ...
 x_ensemble.l = prefix.da.beta2_inv * prefix.da.L.l * y_ensemble.l;
 x_ensemble.s = prefix.da.beta2_inv * prefix.da.L.s * y_ensemble.s;
